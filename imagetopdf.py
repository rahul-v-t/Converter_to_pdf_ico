...
saveAsButton = tk.Button(text='Convert to ICO', command=convertToico, bg='green', fg='white', font=('helvetica', 12, 'bold'))
...
canvas1.create_window(150, 290, window=exitButton)
